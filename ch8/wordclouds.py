...
from ch1.dividing_into_sentences import read_text_file
from ch1.removing_stopwords import compile_stopwords_list_frequency
...
def main():
    text_file = "ch1/sherlock_holmes.txt"
    text = read_text_file(text_file)
    #sherlock_data = Image.open("ch8/sherlock.png")
    #sherlock_mask = np.array(sherlock_data)
    create_wordcloud(text, compile_stopwords_list_frequency(text), "ch8/sherlock_wc.png")
    #create_wordcloud(text, compile_stopwords_list_frequency(text), "ch8/sherlock_mask.png", apply_mask=sherlock_mask)

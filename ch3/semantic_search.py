...
import whoosh.index
import csv
from ch3.word_embeddings import w2vec_model_path
from ch3.word_embeddings import load_model


imdb_dataset_path = "ch3/IMDB-Movie-Data.csv"
search_engine_index_path = "ch3/whoosh_index"

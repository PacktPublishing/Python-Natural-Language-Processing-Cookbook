...
def train_model(df, le):
    tokenizer = create_tokenizer(df['text'].values, 'ch4/bbc_tokenizer.pickle')
...
def main():
    ...
    train_model(df, le)
    #load_and_evaluate_existing_model('ch4/bbc_model.h5', 'ch4/bbc_tokenizer.pickle', df, le)
    #model = load_model('ch4/bbc_model.h5')

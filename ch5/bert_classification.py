...
def main():
    ...
    model = fine_tune_model(dataset, 'ch5/bert_twitter_test2_model')


if(__name__ == "__main__"):
    #main()
    #test_new_example('ch4/bert_twitter_test_model', "I hate going to school")
    load_and_evaluate_existing_model('ch5/bert_twitter_test2_model')
